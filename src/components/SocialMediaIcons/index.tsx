export default function SocialMediaSection() {
  ...
  return (
    <div className="m-4 px-4 pb-8 pt-24 sm:pb-12 sm:pt-40 sm:px-8">
      <div className="max-w-6xl mx-auto text-center m-4">
        ...
        <div className="flex justify-center items-center gap-2 sm:gap-8">
          ...
          <a href={socialLinks[0].url} target="_blank" rel="noopener noreferrer" className="transform hover:scale-110 transition-transform">
            <div className="w-6 h-6 sm:w-16 sm:h-16 bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 rounded-2xl flex items-center justify-center">
              <svg className="w-4 h-4 sm:w-10 sm:h-10 text-white fill-current" viewBox="0 0 24 24">
          ...
          <a href={socialLinks[1].url} target="_blank" rel="noopener noreferrer" className="transform hover:scale-110 transition-transform">
            <div className="w-6 h-6 sm:w-16 sm:h-16 bg-black rounded-xl flex items-center justify-center">
              <svg className="w-4 h-4 sm:w-8 sm:h-8 text-white fill-current" viewBox="0 0 24 24">
          ...
          <a href={socialLinks[2].url} target="_blank" rel="noopener noreferrer" className="transform hover:scale-110 transition-transform">
            <div className="w-6 h-6 sm:w-16 sm:h-16 bg-red-600 rounded-2xl flex items-center justify-center">
              <svg className="w-4 h-4 sm:w-12 sm:h-12 text-white fill-current" viewBox="0 0 24 24">
          ...
          <a href={socialLinks[3].url} target="_blank" rel="noopener noreferrer" className="transform hover:scale-110 transition-transform">
            <div className="w-6 h-6 sm:w-16 sm:h-16 bg-gradient-to-br from-pink-400 to-red-500 rounded-full flex items-center justify-center">
              <svg className="w-4 h-4 sm:w-10 sm:h-10 text-white fill-current" viewBox="0 0 24 24">
