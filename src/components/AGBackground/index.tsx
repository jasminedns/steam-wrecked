...
const BackgroundWrapper = ({ children }: { children: ReactNode }) => {
  return (
    <div className="relative h-full md:min-h-full bg-[linear-gradient(5deg,_rgba(208,120,11,1)_0%,_rgba(125,85,45,1)_32%,_rgba(107,93,93,1)_55%,_rgba(82,74,74,1)_100%)] -mb-36 pb-35 md:-mb-36 md:pb-36">
