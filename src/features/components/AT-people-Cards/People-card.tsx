...
const PeopleCard: React.FC = () => {
  ...
  return (
    <div className="flex justify-center items-center flex-grow bg-gradient-to-b from-[#79221E] to-[#4A1410] relative min-h-[70vh] max-md:min-h-[60vh] max-sm:min-h-[65vh] -mb-58 pb-65 md:-mb-36 md:pb-36">
      {!selectedCategory ? (
