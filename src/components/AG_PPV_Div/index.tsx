    ...
    return (
        ...
        <div className="flex flex-col  lg:basis-[50%] lg:m-4 items-center">
            ...
            <div className="bg-[#060A0A]/65 text-[#F5F5F5] mb-15 m-6  max-w-[500px] lg:w-auto lg:mx-0 sm:m-6 rounded-[64px]">
                <p className="p-[24px] m-4 sm:m-0 lg:p-[48px] text-[16px] md:text-xl charter ">You are a scavenger of the Sandwalkers Guild, tasked with retrieving lost resources from the ruins below. 
