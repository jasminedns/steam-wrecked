 ...
 return (
    <div>
      <div className="flex flex-col min-h-screen">
        ...
        <div className="absolute -mt-3 w-full h-3 bg-gradient-to-b from-transparent to-black/10 backdrop-blur-sm pointer-events-none z-20"></div>
        <div className="relative min-h-[70vh] max-md:min-h-[60vh] max-sm:min-h-[65vh] w-full bg-[url('/images/background/EnvironmentConceptGroundlevel.jpeg')] bg-cover bg-[center_right_20%] sm:bg-right md:bg-center pb-24">
