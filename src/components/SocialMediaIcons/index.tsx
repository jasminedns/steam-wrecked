      ...
      <div className="max-w-6xl mx-auto text-center m-4">
        ...
        <div className="flex justify-center items-center gap-2 sm:gap-8">
          ...
          <a href={socialLinks[0].url} target="_blank" rel="noopener noreferrer" className="transform hover:scale-110 transition-transform">
            <div className="w-10 h-10 sm:w-13 sm:h-13 bg-gradient-to-br from-purple-600 via-pink-500 to-orange-400 rounded-2xl flex items-center justify-center">
              <svg className="w-5 h-5 sm:w-7 sm:h-7 text-white fill-current" viewBox="0 0 24 24">
          ...
          <a href={socialLinks[1].url} target="_blank" rel="noopener noreferrer" className="transform hover:scale-110 transition-transform">
            <div className="w-10 h-10 sm:w-13 sm:h-13 bg-black rounded-xl flex items-center justify-center">
              <svg className="w-5 h-5 sm:w-7 sm:h-7 text-white fill-current" viewBox="0 0 24 24">
          ...
          <a href={socialLinks[2].url} target="_blank" rel="noopener noreferrer" className="transform hover:scale-110 transition-transform">
            <div className="w-10 h-10 sm:w-13 sm:h-13 bg-red-600 rounded-2xl flex items-center justify-center">
              <svg className="w-5 h-5 sm:w-7 sm:h-7 text-white fill-current" viewBox="0 0 24 24">
          ...
          <a href={socialLinks[3].url} target="_blank" rel="noopener noreferrer" className="transform hover:scale-110 transition-transform">
            <div className="w-10 h-10 sm:w-13 sm:h-13 bg-gradient-to-br from-pink-400 to-red-500 rounded-full flex items-center justify-center">
              <svg className="w-5 h-5 sm:w-7 sm:h-7 text-white fill-current" viewBox="0 0 24 24">
